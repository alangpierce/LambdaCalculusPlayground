...
export const ScreenDefinition = buildValueClass('ScreenDefinition', ['defName', 'expr', 'pos', 'defKey', 'refKey', 'emptyBodyKey', 'shouldHighlightEmptyBody', 'key', 'isDragging']);
...
export const DragData = buildValueClass('DragData', ['payload', 'grabOffset', 'screenRect']);
